...
const file_models_person_proto_rawDesc = "" +
	"\n" +
	"\x13models/person.proto\"E\n" +
	...
	"\x04WORK\x10\x02B\x11Z\x0fprotobuf/modelsb\x06proto3"

var (
	file_models_person_proto_rawDescOnce sync.Once
	file_models_person_proto_rawDescData []byte
)

func file_models_person_proto_rawDescGZIP() []byte {
	file_models_person_proto_rawDescOnce.Do(func() {
		file_models_person_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_models_person_proto_rawDesc), len(file_models_person_proto_rawDesc)))
	})
...
func file_models_person_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_models_person_proto_rawDesc), len(file_models_person_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
